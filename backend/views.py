...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/static/app.css?v=ui-20260102-01" />
  </head>
  <body class="app" data-screen="connect">
            ...
            <div class="cards">
              <div class="card card--glass">
                ...
                <div class="checklist" id="checklist">
                  ...
                  <div class="checklist__row"><span class="checklist__k">Оплата отправлена (15 USDT)</span><span class="tag" id="chk-paid">—</span></div>
              ...
              <div class="card card--accent">
                <div class="card__head">
                  ...
                  <div class="card__desc">Шаг 5: оплатите <b>15 USDT</b> через Tonkeeper. После оплаты вставьте tx hash для ручной проверки.</div>
                </div>
                <div class="stack">
                  <button id="btn-pay-create" class="btn btn-indigo btn-lg">Оплатить 15 USDT</button>
            ...
            <div class="cards">
              <div class="card">
                <div class="card__head">
                  ...
                  <div class="card__desc">Когда выполнены условия, можно запросить выплату <b>33 USDT</b>.</div>
                </div>
                <div class="stack">
                  <button id="btn-payout-request" class="btn btn-indigo" disabled>Запросить выплату 33 USDT</button>
        ...
        <aside class="panel panel--side">
          <div class="card card--glass">
            ...
            <ul class="tips">
              ...
              <li><b>5)</b> Нажмите «Оплатить 15 USDT» → «Отправить через кошелёк».</li>
    ...
    <script src="/static/js/app.js?v=app-20260102-01"></script>
  </body>
</html>
"""
